...
//! Project version number for AMDShareModule.
FOUNDATION_EXPORT double AMDShareModuleVersionNumber;

//! Project version string for AMDShareModule.
FOUNDATION_EXPORT const unsigned char AMDShareModuleVersionString[];
